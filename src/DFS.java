...
public class DFS {
    ...
    private final Stack<Node> openList = new Stack<>(); // holds all the explored nodes
    private final ArrayList<String> closedList = new ArrayList<>(); // holds all the generated but not yet explored nodes
    ...
    public boolean solveDFS(){
        ...
        do{
            ...
            // checks if the child is not in the closed list && not in the open list then adds it to the BEGINNING of the list
